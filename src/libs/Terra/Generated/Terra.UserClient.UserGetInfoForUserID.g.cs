...
namespace Terra
{
    public partial class UserClient
    {
        ...
        private static readonly global::Terra.EndPointSecurityRequirement s_UserGetInfoForUserIDSecurityRequirement0 =
        ...
        private static readonly global::Terra.EndPointSecurityRequirement[] s_UserGetInfoForUserIDSecurityRequirements =
            new global::Terra.EndPointSecurityRequirement[]
            {                s_UserGetInfoForUserIDSecurityRequirement0,
            };
        partial void PrepareUserGetInfoForUserIDArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string? userId,
            ref string? referenceId);
        partial void PrepareUserGetInfoForUserIDRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string? userId,
            string? referenceId);
        partial void ProcessUserGetInfoForUserIDResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessUserGetInfoForUserIDResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Terra.OneOf<global::Terra.UserGetInfoForUserIDResponse2, global::System.Collections.Generic.IList<global::Terra.TerraUser>>> UserGetInfoForUserIDAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::Terra.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_UserGetInfoForUserIDSecurityRequirements,
                operationName: "UserGetInfoForUserIDAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareUserGetInfoForUserIDRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Terra.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Terra.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "UserGetInfoForUserID",
                                methodName: "UserGetInfoForUserIDAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessUserGetInfoForUserIDResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Terra.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 400)
                            {
                                ...
                                global::Terra.UserGetInfoForUserIDResponse3? __value_400 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_400 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_400 = global::Terra.UserGetInfoForUserIDResponse3.FromJson(__content_400, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_400 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::Terra.ApiException<global::Terra.UserGetInfoForUserIDResponse3>.Create(
                            ...
                            if ((int)__response.StatusCode == 404)
                            {
                                ...
                                global::Terra.UserGetInfoForUserIDResponse4? __value_404 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_404 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_404 = global::Terra.UserGetInfoForUserIDResponse4.FromJson(__content_404, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_404 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::Terra.ApiException<global::Terra.UserGetInfoForUserIDResponse4>.Create(
                                    statusCode: __response.StatusCode,
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessUserGetInfoForUserIDResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
