...
namespace Terra
{
    ...
    public sealed class AutoSDKClientOptions
    {
        ...
        /// </summary>
        public global::Terra.AutoSDKRetryOptions Retry { get; set; } = new global::Terra.AutoSDKRetryOptions();
        ...
        /// </summary>
        public global::System.Collections.Generic.List<global::Terra.IAutoSDKHook> Hooks { get; } =
            new global::System.Collections.Generic.List<global::Terra.IAutoSDKHook>();
        ...
        public global::Terra.AutoSDKClientOptions AddHook(
            global::Terra.IAutoSDKHook hook)
        {
        ...
        /// </summary>
        public global::Terra.IAutoSDKAuthorizationProvider? AuthorizationProvider { get; set; }
        ...
        public global::Terra.AutoSDKClientOptions UseAuthorizationProvider(
            global::Terra.IAutoSDKAuthorizationProvider provider)
        {
            AuthorizationProvider = provider ?? throw new global::System.ArgumentNullException(nameof(provider));
            if (Hooks.Find(static x => x is global::Terra.AutoSDKAuthorizationProviderHook) == null)
            {
                Hooks.Add(new global::Terra.AutoSDKAuthorizationProviderHook());
            }
    ...
    public readonly struct AutoSDKAuthorizationValue
    {
        ...
        public static global::Terra.AutoSDKAuthorizationValue Bearer(string token) => new(value: token, scheme: "Bearer");

        /// <summary>Convenience factory for an API-key header.</summary>
        public static global::Terra.AutoSDKAuthorizationValue ApiKeyHeader(string name, string value) =>
    ...
    public interface IAutoSDKAuthorizationProvider
    {
        ...
        global::System.Threading.Tasks.Task<global::System.Collections.Generic.IReadOnlyList<global::Terra.AutoSDKAuthorizationValue>?> ResolveAsync(
            global::Terra.AutoSDKHookContext context);
    }
...
#pragma warning restore CS0618
    ...
    /// </summary>
    public sealed class AutoSDKAuthorizationProviderHook : global::Terra.AutoSDKHook
    {
        /// <inheritdoc />
            ...
            global::Terra.AutoSDKHookContext context)
        {
            ...
            if (perRequest != null && perRequest.Count > 0)
            {
                ...
                global::Terra.AutoSDKHttpRequestOptions.StampAuthorizationOverride(context.Request);
                return;
            }
        ...
        private static void ApplyAuthorization(
            global::System.Net.Http.HttpRequestMessage request,
            global::Terra.AutoSDKAuthorizationValue authorization)
        {
    ...
    public sealed class AutoSDKRequestOptions
    {
        ...
        /// </summary>
        public global::Terra.AutoSDKRetryOptions? Retry { get; set; }
        ...
        /// </summary>
        public global::System.Collections.Generic.IReadOnlyList<global::Terra.AutoSDKAuthorizationValue>? Authorizations { get; set; }
    }
    ...
    /// </summary>
    public abstract class AutoSDKHook : global::Terra.IAutoSDKHook
    {
        /// <inheritdoc />
    ...
    public sealed class AutoSDKHookContext
    {
        ...
        /// </summary>
        public global::Terra.AutoSDKClientOptions ClientOptions { get; set; } = null!;

        /// <summary>
        /// The per-request runtime options.
        /// </summary>
        public global::Terra.AutoSDKRequestOptions? RequestOptions { get; set; }
    ...
    {
        internal static global::Terra.AutoSDKHookContext CreateHookContext(
            string operationId,
            string methodName,
            string pathTemplate,
            string httpMethod,
            ...
            global::Terra.AutoSDKClientOptions clientOptions,
            global::Terra.AutoSDKRequestOptions? requestOptions,
            int attempt,
            int maxAttempts,
            bool willRetry,
        ...
        {
            return new global::Terra.AutoSDKHookContext
            {
        ...
        internal static global::System.TimeSpan GetRetryDelay(
            ...
            int attempt)
        {
            var retryOptions = requestOptions?.Retry ?? clientOptions.Retry ?? new global::Terra.AutoSDKRetryOptions();
        ...
        private static global::System.TimeSpan ClampRetryDelay(
            global::System.TimeSpan delay,
            global::Terra.AutoSDKRetryOptions retryOptions)
        {
        ...
        private static async global::System.Threading.Tasks.Task InvokeHooksAsync(
            global::Terra.AutoSDKClientOptions clientOptions,
            global::System.Func<global::Terra.IAutoSDKHook, global::Terra.AutoSDKHookContext, global::System.Threading.Tasks.Task> callback,
            global::Terra.AutoSDKHookContext context)
        {
