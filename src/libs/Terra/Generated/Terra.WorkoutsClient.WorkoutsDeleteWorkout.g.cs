...
namespace Terra
{
    public partial class WorkoutsClient
    {
        ...
        private static readonly global::Terra.EndPointSecurityRequirement s_WorkoutsDeleteWorkoutSecurityRequirement0 =
        ...
        private static readonly global::Terra.EndPointSecurityRequirement[] s_WorkoutsDeleteWorkoutSecurityRequirements =
            new global::Terra.EndPointSecurityRequirement[]
            {                s_WorkoutsDeleteWorkoutSecurityRequirement0,
            };
        partial void PrepareWorkoutsDeleteWorkoutArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string workoutId);
        partial void PrepareWorkoutsDeleteWorkoutRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string workoutId);
        partial void ProcessWorkoutsDeleteWorkoutResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessWorkoutsDeleteWorkoutResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Terra.WorkoutsDeleteWorkoutResponse> WorkoutsDeleteWorkoutAsync(
            string workoutId,
            global::Terra.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await WorkoutsDeleteWorkoutAsResponseAsync(
                workoutId: workoutId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Terra.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Terra.AutoSDKHttpResponse<global::Terra.WorkoutsDeleteWorkoutResponse>> WorkoutsDeleteWorkoutAsResponseAsync(
            string workoutId,
            global::Terra.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareWorkoutsDeleteWorkoutArguments(
            ...
            var __authorizations = global::Terra.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_WorkoutsDeleteWorkoutSecurityRequirements,
                operationName: "WorkoutsDeleteWorkoutAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareWorkoutsDeleteWorkoutRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Terra.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Terra.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "WorkoutsDeleteWorkout",
                                methodName: "WorkoutsDeleteWorkoutAsync",
                                pathTemplate: "$\"/workouts/{workoutId}\"",
                                httpMethod: "DELETE",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessWorkoutsDeleteWorkoutResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Terra.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            // Provider-side deletion could not be performed; retry later.
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessWorkoutsDeleteWorkoutResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Terra.WorkoutsDeleteWorkoutResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Terra.AutoSDKHttpResponse<global::Terra.WorkoutsDeleteWorkoutResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Terra.WorkoutsDeleteWorkoutResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
