...
namespace Terra
{
    public partial class WorkoutsClient
    {
        ...
        private static readonly global::Terra.EndPointSecurityRequirement s_WorkoutsListPlannedWorkoutsSecurityRequirement0 =
        ...
        private static readonly global::Terra.EndPointSecurityRequirement[] s_WorkoutsListPlannedWorkoutsSecurityRequirements =
            new global::Terra.EndPointSecurityRequirement[]
            {                s_WorkoutsListPlannedWorkoutsSecurityRequirement0,
            };
        ...
        partial void ProcessWorkoutsListPlannedWorkoutsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::Terra.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_WorkoutsListPlannedWorkoutsSecurityRequirements,
                operationName: "WorkoutsListPlannedWorkoutsAsync");
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Terra.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Terra.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "WorkoutsListPlannedWorkouts",
                                methodName: "WorkoutsListPlannedWorkoutsAsync",
                                pathTemplate: "\"/plannedWorkouts\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessWorkoutsListPlannedWorkoutsResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Terra.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessWorkoutsListPlannedWorkoutsResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = (global::System.Collections.Generic.IList<global::Terra.PlannedWorkout>?)global::System.Text.Json.JsonSerializer.Deserialize(__content, typeof(global::System.Collections.Generic.IList<global::Terra.PlannedWorkout>), JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Terra.AutoSDKHttpResponse<global::System.Collections.Generic.IList<global::Terra.PlannedWorkout>>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = (global::System.Collections.Generic.IList<global::Terra.PlannedWorkout>?)await global::System.Text.Json.JsonSerializer.DeserializeAsync(__content, typeof(global::System.Collections.Generic.IList<global::Terra.PlannedWorkout>), JsonSerializerContext).ConfigureAwait(false) ??
