...
{
    /// <inheritdoc />
    public class PlannedWorkoutSportJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::Terra.PlannedWorkoutSport>
    {
        /// <inheritdoc />
        public override global::Terra.PlannedWorkoutSport Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            var __score0 = 0;
            {
                var __ti = typeInfoResolver.GetTypeInfo(typeof(global::Terra.WorkoutSport), options);
            ...
            var __score1 = 0;
            {
                var __ti = typeInfoResolver.GetTypeInfo(typeof(global::Terra.PlannedWorkoutSportEnum), options);
                if (__ti != null && __ti.Kind == global::System.Text.Json.Serialization.Metadata.JsonTypeInfoKind.Object)
                {
                    foreach (var __prop in __ti.Properties)
                    {
            ...
            global::Terra.WorkoutSport? workoutSport = default;
            global::Terra.PlannedWorkoutSportEnum? @enum = default;
            if (__bestIndex >= 0)
            {
                if (__bestIndex == 0)
                {
                    try
                    {
                        ...
                        workoutSport = global::System.Text.Json.JsonSerializer.Deserialize(__rawJson, typeInfo);
                    }
            ...
            if (workoutSport == null && @enum == null)
            {
                try
                {
            ...
            var __value = new global::Terra.PlannedWorkoutSport(
                workoutSport,
        ...
        public override void Write(
            ...
            global::Terra.PlannedWorkoutSport value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");

            if (value.IsWorkoutSport)
            {
                var typeInfo = typeInfoResolver.GetTypeInfo(typeof(global::Terra.WorkoutSport), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::Terra.WorkoutSport> ??
                               throw new global::System.InvalidOperationException($"Cannot get type info for {typeof(global::Terra.WorkoutSport).Name}");
