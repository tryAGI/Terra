...
namespace Terra
{
    public partial class PlannedWorkoutClient
    {
        ...
        partial void PreparePlannedWorkoutFetchArguments(
            ...
            ref bool? toWebhook);
        partial void PreparePlannedWorkoutFetchRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            bool? toWebhook);
        partial void ProcessPlannedWorkoutFetchResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessPlannedWorkoutFetchResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Terra.OneOf<global::Terra.PlannedWorkoutFetchResponse2, global::Terra.NoDataReturned, global::Terra.DataSentToWebhook>> PlannedWorkoutFetchAsync(
            string userId,
            global::Terra.OneOf<int?, global::System.DateTime?> startDate,
        ...
        {
            var __response = await PlannedWorkoutFetchAsResponseAsync(
                userId: userId,
                startDate: startDate,
                endDate: endDate,
                toWebhook: toWebhook,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Terra.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Terra.AutoSDKHttpResponse<global::Terra.OneOf<global::Terra.PlannedWorkoutFetchResponse2, global::Terra.NoDataReturned, global::Terra.DataSentToWebhook>>> PlannedWorkoutFetchAsResponseAsync(
            string userId,
            global::Terra.OneOf<int?, global::System.DateTime?> startDate,
            global::Terra.OneOf<int?, global::System.DateTime?>? endDate = default,
            bool? toWebhook = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PreparePlannedWorkoutFetchArguments(
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Terra.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Terra.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "PlannedWorkoutFetch",
                                methodName: "PlannedWorkoutFetchAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessPlannedWorkoutFetchResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Terra.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 400)
                            {
                                ...
                                global::Terra.PlannedWorkoutFetchResponse3? __value_400 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_400 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_400 = global::Terra.PlannedWorkoutFetchResponse3.FromJson(__content_400, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_400 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::Terra.ApiException<global::Terra.PlannedWorkoutFetchResponse3>.Create(
                            ...
                            if ((int)__response.StatusCode == 401)
                            {
                                ...
                                global::Terra.PlannedWorkoutFetchResponse4? __value_401 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_401 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_401 = global::Terra.PlannedWorkoutFetchResponse4.FromJson(__content_401, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_401 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::Terra.ApiException<global::Terra.PlannedWorkoutFetchResponse4>.Create(
                                    statusCode: __response.StatusCode,
                            ...
                            if ((int)__response.StatusCode == 404)
                            {
                                ...
                                global::Terra.PlannedWorkoutFetchResponse5? __value_404 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_404 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_404 = global::Terra.PlannedWorkoutFetchResponse5.FromJson(__content_404, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_404 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::Terra.ApiException<global::Terra.PlannedWorkoutFetchResponse5>.Create(
                                    statusCode: __response.StatusCode,
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessPlannedWorkoutFetchResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Terra.OneOf<global::Terra.PlannedWorkoutFetchResponse2, global::Terra.NoDataReturned, global::Terra.DataSentToWebhook>.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Terra.AutoSDKHttpResponse<global::Terra.OneOf<global::Terra.PlannedWorkoutFetchResponse2, global::Terra.NoDataReturned, global::Terra.DataSentToWebhook>>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Terra.OneOf<global::Terra.PlannedWorkoutFetchResponse2, global::Terra.NoDataReturned, global::Terra.DataSentToWebhook>.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
