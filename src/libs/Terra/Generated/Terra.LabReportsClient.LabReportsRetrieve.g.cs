...
namespace Terra
{
    public partial class LabReportsClient
    {
        ...
        private static readonly global::Terra.EndPointSecurityRequirement s_LabReportsRetrieveSecurityRequirement0 =
        ...
        private static readonly global::Terra.EndPointSecurityRequirement[] s_LabReportsRetrieveSecurityRequirements =
            new global::Terra.EndPointSecurityRequirement[]
            {                s_LabReportsRetrieveSecurityRequirement0,
            };
        partial void PrepareLabReportsRetrieveArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string sessionId);
        partial void PrepareLabReportsRetrieveRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string sessionId);
        partial void ProcessLabReportsRetrieveResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessLabReportsRetrieveResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Terra.LabReportSession> LabReportsRetrieveAsync(
            string sessionId,
            global::Terra.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await LabReportsRetrieveAsResponseAsync(
                sessionId: sessionId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Terra.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Terra.AutoSDKHttpResponse<global::Terra.LabReportSession>> LabReportsRetrieveAsResponseAsync(
            string sessionId,
            global::Terra.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareLabReportsRetrieveArguments(
            ...
            var __authorizations = global::Terra.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_LabReportsRetrieveSecurityRequirements,
                operationName: "LabReportsRetrieveAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareLabReportsRetrieveRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Terra.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Terra.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "LabReportsRetrieve",
                                methodName: "LabReportsRetrieveAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessLabReportsRetrieveResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Terra.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessLabReportsRetrieveResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
