...
namespace Terra
{
    public partial class BodyClient
    {
        ...
        private static readonly global::Terra.EndPointSecurityRequirement s_BodyDeleteSecurityRequirement0 =
        ...
        private static readonly global::Terra.EndPointSecurityRequirement[] s_BodyDeleteSecurityRequirements =
            new global::Terra.EndPointSecurityRequirement[]
            {                s_BodyDeleteSecurityRequirement0,
            };
        partial void PrepareBodyDeleteArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string userId,
            global::Terra.BodyDeleteRequest request);
        partial void PrepareBodyDeleteRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string userId,
            global::Terra.BodyDeleteRequest request);
        partial void ProcessBodyDeleteResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessBodyDeleteResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Terra.BodyDeleteResponse> BodyDeleteAsync(
            string userId,
        ...
        {
            var __response = await BodyDeleteAsResponseAsync(
                userId: userId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Terra.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Terra.AutoSDKHttpResponse<global::Terra.BodyDeleteResponse>> BodyDeleteAsResponseAsync(
            string userId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::Terra.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_BodyDeleteSecurityRequirements,
                operationName: "BodyDeleteAsync");
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Terra.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Terra.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "BodyDelete",
                                methodName: "BodyDeleteAsync",
                                pathTemplate: "\"/body\"",
                                httpMethod: "DELETE",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                ...
                else
                {
                    await global::Terra.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 400)
                            {
                                ...
                                global::Terra.BodyDeleteResponse3? __value_400 = null;
                                try
                                {
                                ...
                                throw global::Terra.ApiException<global::Terra.BodyDeleteResponse3>.Create(
                            ...
                            if ((int)__response.StatusCode == 401)
                            {
                                ...
                                global::Terra.BodyDeleteResponse4? __value_401 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                ...
                                throw global::Terra.ApiException<global::Terra.BodyDeleteResponse4>.Create(
                                    statusCode: __response.StatusCode,
                            ...
                            if ((int)__response.StatusCode == 404)
                            {
                                ...
                                global::Terra.BodyDeleteResponse5? __value_404 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                ...
                                throw global::Terra.ApiException<global::Terra.BodyDeleteResponse5>.Create(
                                    statusCode: __response.StatusCode,
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessBodyDeleteResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Terra.BodyDeleteResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Terra.AutoSDKHttpResponse<global::Terra.BodyDeleteResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Terra.BodyDeleteResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Terra.BodyDeleteResponse> BodyDeleteAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Terra.BodyDeleteRequest
            {
                LogIds = logIds,
            };

            return await BodyDeleteAsync(
                userId: userId,
                request: __request,
                requestOptions: requestOptions,
