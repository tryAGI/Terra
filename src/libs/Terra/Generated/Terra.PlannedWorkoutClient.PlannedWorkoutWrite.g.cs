...
namespace Terra
{
    public partial class PlannedWorkoutClient
    {
        ...
        private static readonly global::Terra.EndPointSecurityRequirement s_PlannedWorkoutWriteSecurityRequirement0 =
        ...
        private static readonly global::Terra.EndPointSecurityRequirement[] s_PlannedWorkoutWriteSecurityRequirements =
            new global::Terra.EndPointSecurityRequirement[]
            {                s_PlannedWorkoutWriteSecurityRequirement0,
            };
        partial void PreparePlannedWorkoutWriteArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string userId,
            global::Terra.PlannedWorkoutWriteRequest request);
        partial void PreparePlannedWorkoutWriteRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string userId,
            global::Terra.PlannedWorkoutWriteRequest request);
        partial void ProcessPlannedWorkoutWriteResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessPlannedWorkoutWriteResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Terra.PlannedWorkoutWriteResponse> PlannedWorkoutWriteAsync(
            string userId,
        ...
        {
            var __response = await PlannedWorkoutWriteAsResponseAsync(
                userId: userId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Terra.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Terra.AutoSDKHttpResponse<global::Terra.PlannedWorkoutWriteResponse>> PlannedWorkoutWriteAsResponseAsync(
            string userId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PreparePlannedWorkoutWriteArguments(
            ...
            var __authorizations = global::Terra.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_PlannedWorkoutWriteSecurityRequirements,
                operationName: "PlannedWorkoutWriteAsync");
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Terra.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Terra.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "PlannedWorkoutWrite",
                                methodName: "PlannedWorkoutWriteAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessPlannedWorkoutWriteResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Terra.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 400)
                            {
                                ...
                                global::Terra.PlannedWorkoutWriteResponse2? __value_400 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_400 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_400 = global::Terra.PlannedWorkoutWriteResponse2.FromJson(__content_400, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_400 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::Terra.ApiException<global::Terra.PlannedWorkoutWriteResponse2>.Create(
                            ...
                            if ((int)__response.StatusCode == 404)
                            {
                                ...
                                global::Terra.PlannedWorkoutWriteResponse3? __value_404 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_404 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_404 = global::Terra.PlannedWorkoutWriteResponse3.FromJson(__content_404, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_404 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::Terra.ApiException<global::Terra.PlannedWorkoutWriteResponse3>.Create(
                                    statusCode: __response.StatusCode,
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessPlannedWorkoutWriteResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Terra.PlannedWorkoutWriteResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Terra.AutoSDKHttpResponse<global::Terra.PlannedWorkoutWriteResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Terra.PlannedWorkoutWriteResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Terra.PlannedWorkoutWriteResponse> PlannedWorkoutWriteAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Terra.PlannedWorkoutWriteRequest
            {
                Data = data,
            };

            return await PlannedWorkoutWriteAsync(
                userId: userId,
                request: __request,
                requestOptions: requestOptions,
