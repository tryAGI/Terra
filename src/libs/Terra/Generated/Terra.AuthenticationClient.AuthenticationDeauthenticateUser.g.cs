    ...
    public partial class AuthenticationClient
    {
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            if ((int)__response.StatusCode == 404)
            {
                ...
                global::Terra.AuthenticationDeauthenticateUserResponse2? __value_404 = null;
                try
                {
                    if (ReadResponseAsString)
                    {
                        __content_404 = await __response.Content.ReadAsStringAsync(cancellationToken).ConfigureAwait(false);
                        __value_404 = global::Terra.AuthenticationDeauthenticateUserResponse2.FromJson(__content_404, JsonSerializerOptions);
                    }
                    else
                    {
                        __content_404 = await __response.Content.ReadAsStringAsync(cancellationToken).ConfigureAwait(false);
                ...
                throw new global::Terra.ApiException<global::Terra.AuthenticationDeauthenticateUserResponse2>(
            ...
            if (ReadResponseAsString)
            {
                ...
                try
                {
                    ...
                    return
                        global::Terra.AuthenticationDeauthenticateUserResponse.FromJson(__content, JsonSerializerOptions) ??
            ...
            else
            {
                try
                {
                    ...
                    return
                        await global::Terra.AuthenticationDeauthenticateUserResponse.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
