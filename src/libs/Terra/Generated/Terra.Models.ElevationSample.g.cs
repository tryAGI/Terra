...
namespace Terra
{
    ...
    public sealed partial class ElevationSample
    {
        ...
        /// <summary>
        /// User's altitude at a given point in time, in meters above sea level.<br/>
        /// Example: 925
        /// </summary>
        /// <example>925</example>
        [global::System.Text.Json.Serialization.JsonPropertyName("elev_meters")]
        public double? ElevMeters { get; set; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ElevationSample" /> class.
        /// </summary>
        /// <param name="timestamp">
        /// Time with which the record is associated, in ISO8601 format with microsecond precision. TimeZone info will be provided whenever possible. If absent, the time corresponds to the user's local time.<br/>
        /// Example: 2022-11-23T09:00:00.000000+02:00
        /// </param>
        /// <param name="elevMeters">
        /// User's altitude at a given point in time, in meters above sea level.<br/>
        /// Example: 925
        /// </param>
