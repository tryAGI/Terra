...
{
    /// <inheritdoc />
    public class WorkoutStepIntensityJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::Terra.WorkoutStepIntensity>
    {
        /// <inheritdoc />
        public override global::Terra.WorkoutStepIntensity Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            var __score0 = 0;
            {
                var __ti = typeInfoResolver.GetTypeInfo(typeof(global::Terra.WorkoutStepIntensityVariant1), options);
            ...
            var __score1 = 0;
            {
                var __ti = typeInfoResolver.GetTypeInfo(typeof(global::Terra.WorkoutStepIntensityVariant2), options);
                if (__ti != null && __ti.Kind == global::System.Text.Json.Serialization.Metadata.JsonTypeInfoKind.Object)
                {
                    foreach (var __prop in __ti.Properties)
                    {
            ...
            var __score2 = 0;
            {
                var __ti = typeInfoResolver.GetTypeInfo(typeof(global::Terra.WorkoutStepIntensityVariant3), options);
                if (__ti != null && __ti.Kind == global::System.Text.Json.Serialization.Metadata.JsonTypeInfoKind.Object)
                {
                    foreach (var __prop in __ti.Properties)
                    {
            ...
            var __score3 = 0;
            {
                var __ti = typeInfoResolver.GetTypeInfo(typeof(global::Terra.WorkoutStepIntensityVariant4), options);
                if (__ti != null && __ti.Kind == global::System.Text.Json.Serialization.Metadata.JsonTypeInfoKind.Object)
                {
                    foreach (var __prop in __ti.Properties)
                    {
            ...
            var __score4 = 0;
            {
                var __ti = typeInfoResolver.GetTypeInfo(typeof(global::Terra.WorkoutStepIntensityVariant5), options);
                if (__ti != null && __ti.Kind == global::System.Text.Json.Serialization.Metadata.JsonTypeInfoKind.Object)
                {
                    foreach (var __prop in __ti.Properties)
                    {
            ...
            global::Terra.WorkoutStepIntensityVariant1? workoutStepIntensityVariant1 = default;
            global::Terra.WorkoutStepIntensityVariant2? workoutStepIntensityVariant2 = default;
            global::Terra.WorkoutStepIntensityVariant3? workoutStepIntensityVariant3 = default;
            global::Terra.WorkoutStepIntensityVariant4? workoutStepIntensityVariant4 = default;
            global::Terra.WorkoutStepIntensityVariant5? workoutStepIntensityVariant5 = default;
            if (__bestIndex >= 0)
            {
                if (__bestIndex == 0)
                {
                    try
                    {
                        ...
                        workoutStepIntensityVariant1 = global::System.Text.Json.JsonSerializer.Deserialize(__rawJson, typeInfo);
                    }
                ...
                else if (__bestIndex == 1)
                {
                    try
                    {
                        ...
                        workoutStepIntensityVariant2 = global::System.Text.Json.JsonSerializer.Deserialize(__rawJson, typeInfo);
                    }
                    catch (global::System.Text.Json.JsonException)
                    {
                    }
                ...
                else if (__bestIndex == 2)
                {
                    try
                    {
                        ...
                        workoutStepIntensityVariant3 = global::System.Text.Json.JsonSerializer.Deserialize(__rawJson, typeInfo);
                    }
                    catch (global::System.Text.Json.JsonException)
                    {
                    }
                ...
                else if (__bestIndex == 3)
                {
                    try
                    {
                        ...
                        workoutStepIntensityVariant4 = global::System.Text.Json.JsonSerializer.Deserialize(__rawJson, typeInfo);
                    }
                    catch (global::System.Text.Json.JsonException)
                    {
                    }
                ...
                else if (__bestIndex == 4)
                {
                    try
                    {
                        ...
                        workoutStepIntensityVariant5 = global::System.Text.Json.JsonSerializer.Deserialize(__rawJson, typeInfo);
                    }
                    catch (global::System.Text.Json.JsonException)
                    {
                    }
            ...
            if (workoutStepIntensityVariant1 == null && workoutStepIntensityVariant2 == null && workoutStepIntensityVariant3 == null && workoutStepIntensityVariant4 == null && workoutStepIntensityVariant5 == null)
            {
                try
                {
            ...
            var __value = new global::Terra.WorkoutStepIntensity(
        ...
        public override void Write(
            ...
            global::Terra.WorkoutStepIntensity value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");

            if (value.IsWorkoutStepIntensityVariant1)
            {
                var typeInfo = typeInfoResolver.GetTypeInfo(typeof(global::Terra.WorkoutStepIntensityVariant1), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::Terra.WorkoutStepIntensityVariant1> ??
                               throw new global::System.InvalidOperationException($"Cannot get type info for {typeof(global::Terra.WorkoutStepIntensityVariant1).Name}");
