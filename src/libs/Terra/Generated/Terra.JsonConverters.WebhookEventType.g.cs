...
namespace Terra.JsonConverters
{
    ...
    public class WebhookEventTypeJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::Terra.WebhookEventType>
    {
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            if (__jsonProps.Contains("user.active")) __score1++;
            if (__jsonProps.Contains("user.last_webhook_update")) __score1++;
            if (__jsonProps.Contains("user.provider")) __score1++;
            if (__jsonProps.Contains("user.reference_id")) __score1++;
            if (__jsonProps.Contains("user.scopes")) __score1++;
            if (__jsonProps.Contains("user.user_id")) __score1++;
            ...
            if (__jsonProps.Contains("user.active")) __score3++;
            if (__jsonProps.Contains("user.last_webhook_update")) __score3++;
            if (__jsonProps.Contains("user.provider")) __score3++;
            if (__jsonProps.Contains("user.reference_id")) __score3++;
            if (__jsonProps.Contains("user.scopes")) __score3++;
            if (__jsonProps.Contains("user.user_id")) __score3++;
            var __score4 = 0;
            if (__jsonProps.Contains("message")) __score4++;
            if (__jsonProps.Contains("new_user")) __score4++;
            if (__jsonProps.Contains("new_user.active")) __score4++;
            if (__jsonProps.Contains("new_user.last_webhook_update")) __score4++;
            if (__jsonProps.Contains("new_user.provider")) __score4++;
            if (__jsonProps.Contains("new_user.reference_id")) __score4++;
            if (__jsonProps.Contains("new_user.scopes")) __score4++;
            if (__jsonProps.Contains("new_user.user_id")) __score4++;
            if (__jsonProps.Contains("old_user")) __score4++;
            if (__jsonProps.Contains("old_user.active")) __score4++;
            if (__jsonProps.Contains("old_user.last_webhook_update")) __score4++;
            if (__jsonProps.Contains("old_user.provider")) __score4++;
            if (__jsonProps.Contains("old_user.reference_id")) __score4++;
            if (__jsonProps.Contains("old_user.scopes")) __score4++;
            if (__jsonProps.Contains("old_user.user_id")) __score4++;
            ...
            if (__jsonProps.Contains("athlete.age")) __score14++;
            if (__jsonProps.Contains("athlete.bio")) __score14++;
            if (__jsonProps.Contains("athlete.city")) __score14++;
            if (__jsonProps.Contains("athlete.country")) __score14++;
            if (__jsonProps.Contains("athlete.date_of_birth")) __score14++;
            if (__jsonProps.Contains("athlete.devices")) __score14++;
            if (__jsonProps.Contains("athlete.email")) __score14++;
            if (__jsonProps.Contains("athlete.first_name")) __score14++;
            if (__jsonProps.Contains("athlete.gender")) __score14++;
            if (__jsonProps.Contains("athlete.joined_provider")) __score14++;
            if (__jsonProps.Contains("athlete.last_name")) __score14++;
            if (__jsonProps.Contains("athlete.sex")) __score14++;
            if (__jsonProps.Contains("athlete.state")) __score14++;
            ...
            if (__jsonProps.Contains("user.active")) __score16++;
            if (__jsonProps.Contains("user.last_webhook_update")) __score16++;
            if (__jsonProps.Contains("user.provider")) __score16++;
            if (__jsonProps.Contains("user.reference_id")) __score16++;
            if (__jsonProps.Contains("user.scopes")) __score16++;
            if (__jsonProps.Contains("user.user_id")) __score16++;
            ...
            if (__jsonProps.Contains("user.active")) __score17++;
            if (__jsonProps.Contains("user.last_webhook_update")) __score17++;
            if (__jsonProps.Contains("user.provider")) __score17++;
            if (__jsonProps.Contains("user.reference_id")) __score17++;
            if (__jsonProps.Contains("user.scopes")) __score17++;
            if (__jsonProps.Contains("user.user_id")) __score17++;
            ...
            if (__jsonProps.Contains("user.active")) __score19++;
            if (__jsonProps.Contains("user.last_webhook_update")) __score19++;
            if (__jsonProps.Contains("user.provider")) __score19++;
            if (__jsonProps.Contains("user.reference_id")) __score19++;
            if (__jsonProps.Contains("user.scopes")) __score19++;
            if (__jsonProps.Contains("user.user_id")) __score19++;
