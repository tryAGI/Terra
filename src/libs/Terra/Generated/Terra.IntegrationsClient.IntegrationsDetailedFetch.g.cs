...
namespace Terra
{
    public partial class IntegrationsClient
    {
        ...
        {
            var __response = await IntegrationsDetailedFetchAsResponseAsync(
                sdk: sdk,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Terra.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Terra.AutoSDKHttpResponse<global::Terra.IntegrationsResponse>> IntegrationsDetailedFetchAsResponseAsync(
            bool? sdk = default,
            global::Terra.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
