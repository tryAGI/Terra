...
namespace Terra
{
    public partial class IntegrationsClient
    {
        ...
        private static readonly global::Terra.EndPointSecurityRequirement s_IntegrationsFetchSecurityRequirement0 =
        ...
        private static readonly global::Terra.EndPointSecurityRequirement[] s_IntegrationsFetchSecurityRequirements =
            new global::Terra.EndPointSecurityRequirement[]
            {                s_IntegrationsFetchSecurityRequirement0,
            };
        partial void PrepareIntegrationsFetchArguments(
            global::System.Net.Http.HttpClient httpClient);
        partial void PrepareIntegrationsFetchRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage);
        partial void ProcessIntegrationsFetchResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessIntegrationsFetchResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Terra.IntegrationsFetchResponse> IntegrationsFetchAsync(
            global::Terra.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await IntegrationsFetchAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Terra.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Terra.AutoSDKHttpResponse<global::Terra.IntegrationsFetchResponse>> IntegrationsFetchAsResponseAsync(
            global::Terra.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareIntegrationsFetchArguments(
                httpClient: HttpClient);


            var __authorizations = global::Terra.EndPointSecurityResolver.ResolveAuthorizations(
                availableAuthorizations: Authorizations,
                securityRequirements: s_IntegrationsFetchSecurityRequirements,
                operationName: "IntegrationsFetchAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareIntegrationsFetchRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Terra.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Terra.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "IntegrationsFetch",
                                methodName: "IntegrationsFetchAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessIntegrationsFetchResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Terra.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessIntegrationsFetchResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Terra.IntegrationsFetchResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Terra.AutoSDKHttpResponse<global::Terra.IntegrationsFetchResponse>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Terra.IntegrationsFetchResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
