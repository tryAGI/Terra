...
namespace Terra
{
    public partial class WorkoutsClient
    {
        ...
        private static readonly global::Terra.EndPointSecurityRequirement s_WorkoutsUpdatePlannedWorkoutSecurityRequirement0 =
        ...
        private static readonly global::Terra.EndPointSecurityRequirement[] s_WorkoutsUpdatePlannedWorkoutSecurityRequirements =
            new global::Terra.EndPointSecurityRequirement[]
            {                s_WorkoutsUpdatePlannedWorkoutSecurityRequirement0,
            };
        ...
        partial void ProcessWorkoutsUpdatePlannedWorkoutResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::Terra.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_WorkoutsUpdatePlannedWorkoutSecurityRequirements,
                operationName: "WorkoutsUpdatePlannedWorkoutAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareWorkoutsUpdatePlannedWorkoutRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Terra.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Terra.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "WorkoutsUpdatePlannedWorkout",
                                methodName: "WorkoutsUpdatePlannedWorkoutAsync",
                                pathTemplate: "$\"/plannedWorkouts/{plannedWorkoutId}\"",
                                httpMethod: "PATCH",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessWorkoutsUpdatePlannedWorkoutResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Terra.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessWorkoutsUpdatePlannedWorkoutResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Terra.PlannedWorkoutSummary.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Terra.AutoSDKHttpResponse<global::Terra.PlannedWorkoutSummary>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Terra.PlannedWorkoutSummary.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Terra.PlannedWorkoutSummary> WorkoutsUpdatePlannedWorkoutAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Terra.WorkoutsUpdatePlannedWorkoutRequest
            {
