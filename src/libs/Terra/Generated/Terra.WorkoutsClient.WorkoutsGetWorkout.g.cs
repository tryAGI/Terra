...
namespace Terra
{
    public partial class WorkoutsClient
    {
        ...
        private static readonly global::Terra.EndPointSecurityRequirement s_WorkoutsGetWorkoutSecurityRequirement0 =
        ...
        private static readonly global::Terra.EndPointSecurityRequirement[] s_WorkoutsGetWorkoutSecurityRequirements =
            new global::Terra.EndPointSecurityRequirement[]
            {                s_WorkoutsGetWorkoutSecurityRequirement0,
            };
        ...
        partial void ProcessWorkoutsGetWorkoutResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        {
            var __response = await WorkoutsGetWorkoutAsResponseAsync(
                workoutId: workoutId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareWorkoutsGetWorkoutArguments(
            ...
            var __authorizations = global::Terra.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_WorkoutsGetWorkoutSecurityRequirements,
                operationName: "WorkoutsGetWorkoutAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareWorkoutsGetWorkoutRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Terra.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Terra.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "WorkoutsGetWorkout",
                                methodName: "WorkoutsGetWorkoutAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessWorkoutsGetWorkoutResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Terra.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessWorkoutsGetWorkoutResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Terra.WorkoutTemplate.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Terra.AutoSDKHttpResponse<global::Terra.WorkoutTemplate>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Terra.WorkoutTemplate.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
