...
The Terra SDK provides integration with [Microsoft.Extensions.AI](https://learn.microsoft.com/en-us/dotnet/ai/microsoft-extensions-ai), enabling seamless interoperability with the unified .NET AI abstractions.
...
using var client = new TerraClient(
    apiKey: Environment.GetEnvironmentVariable("TERRA_API_KEY")!);
